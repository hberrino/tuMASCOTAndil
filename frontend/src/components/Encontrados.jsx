        ...
        <>
          <div className="pet-carousel pet-carousel-found">
            <div className="pet-carousel-head">
              ...
              <div>
                <button type="button" onClick={mostrarAnterior} aria-label="Mascotas encontradas anteriores">←</button>
                <button type="button" onClick={mostrarSiguiente} aria-label="Mascotas encontradas siguientes">→</button>
              </div>
            </div>
            <div className="pet-carousel-track" key={`encontrados-${indice}`}>
